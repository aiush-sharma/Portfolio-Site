            ...
            >
              ...
              <div className="w-full aspect-[3/4] overflow-hidden bg-neutral-900 relative">
                <img
                  src={item.src}
                  alt={item.title}
                  className="w-full h-full object-cover grayscale brightness-90 contrast-105 transition-all duration-700 ease-out group-hover:scale-105 group-hover:grayscale-0 group-hover:brightness-100"
                />
