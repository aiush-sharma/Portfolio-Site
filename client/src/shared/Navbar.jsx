    ...
    <nav className="fixed top-0 left-0 right-0 h-20 bg-[#1c1c1c]/90 backdrop-blur-md text-white border-b border-white/5 z-50 font-sans tracking-wide">
      <div className="max-w-7xl mx-auto h-full px-6 sm:px-8 md:px-12 lg:px-16 flex items-center justify-between">
        ...
        <div className="hidden md:block">
          <a 
            href="https://www.instagram.com/amplifier_ayush/" 
            target="_blank"
            rel="noopener noreferrer"
            className="text-xs font-bold uppercase tracking-widest border border-white/10 px-5 py-2.5 hover:bg-white hover:text-[#1c1c1c] transition-all duration-300 cursor-pointer"
          >
            Get In Touch
          </a>
        </div>
      ...
      >
        <div className="flex flex-col gap-5">
          ...
          <a
            ...
            rel="noopener noreferrer"
            onClick={() => setIsOpen(false)}
            className="text-center text-xs font-bold uppercase tracking-widest bg-white text-[#1c1c1c] py-3 mt-2 font-mono cursor-pointer"
          >
            Get In Touch
          </a>
        </div>
